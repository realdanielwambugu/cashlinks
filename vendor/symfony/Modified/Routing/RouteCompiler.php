 ...
 */
 ...
 namespace Symfony\Modified\Routing;
...
class RouteCompiler implements RouteCompilerInterface
{
    ...
    private static function compilePattern($route, string $pattern, bool $isHost): array
    {
        $tokens = [];
        $variables = [];
        $matches = [];
     ...
     */
    private static function determineStaticPrefix($route, array $tokens): string
    {
        if ('text' !== $tokens[0][0]) {
